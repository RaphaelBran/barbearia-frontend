...
async function initDatabase() {
    try {
        ...
        console.log('Tabela bookings dropada');
        
        console.log('Criando tabela bookings com schema correto (coluna service sem acento)...');
        await sql`
        ...
        `;
        console.log('Tabela bookings criada com sucesso - coluna: service (sem acento)');
